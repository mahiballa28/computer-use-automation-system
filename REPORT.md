...
### 7.1 Semantic Element Fingerprinting (B1)
...
### 7.2 Execution Trace Anomaly Detection (B2)
...
### 7.3 Capability Composition — DAG Workflows (B3)
...
### 7.4 Visual Regression Detection
...
### 7.6 TF-IDF Capability Discovery
...
### 7.7 Adaptive Timing Prediction
...
| Real LLM discovery evidence | **Completed** — full discovery + replay evidence in `/evidence/` with screenshots, traces, and extracted data. | — |
